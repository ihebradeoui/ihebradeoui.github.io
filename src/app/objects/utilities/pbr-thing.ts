...
export class pbrThing {
    ...
    CreateScene():Scene
    {
        ...
        ground.material = this.CreateGroundMaterial(100);
        ground.onAfterRenderObservable.addOnce((data)=>
        {ground.physicsImpostor = new PhysicsImpostor(ground, PhysicsImpostor.HeightmapImpostor, { mass: 0, restitution: 0.2,friction: 1  }, scene);}
        )
...
//pointer
 ...
 // gravity and collision
        ...
        this.movementService.getAllCoordinates(this.lobby).subscribe((res)=>{this.listCoordinates(res,ball)
...
listCoordinates(entries: any[],ball : Mesh){
    ...
    this.Coordinates.forEach(element => {
        if (!this.users.includes(element.user)){
            ...
            ballo.material=this.CreateBallMaterial();     
